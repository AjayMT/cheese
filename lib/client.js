...
if (typeof require === 'function' && typeof module === 'object') {
  ...
  var DOMUtils = require(path.join(__dirname, 'dom.js'));
  var diffUtils = require(path.join(__dirname, 'diff.js'));
  var jQuery = require(path.join(__dirname, 'jquery-1.10.2.min.js'));
...
(function ($, DOM, diff) {
  ...
  Cheese.reload = function () {
    ...
    if (domLoaded && (! Cheese.opts['update DOM'])) return;
